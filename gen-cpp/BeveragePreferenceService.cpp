    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->btype = (BeverageType::type)ecast5;
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (Beverages::type)ecast6;
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (Beverages::type)ecast7;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
Beverages::type BeveragePreferenceServiceClient::GetBeverage(const BeverageType::type btype)
{
...
Beverages::type BeveragePreferenceServiceClient::recv_GetBeverage()
{
...
void BeveragePreferenceServiceProcessor::process_GetBeverage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->GetBeverage(args.btype);
...
Beverages::type BeveragePreferenceServiceConcurrentClient::GetBeverage(const BeverageType::type btype)
{
...
Beverages::type BeveragePreferenceServiceConcurrentClient::recv_GetBeverage(const int32_t seqid)
{
